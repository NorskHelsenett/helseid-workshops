...
public class DPoPProofCreator
{
    ...
    public DPoPProofCreator(SecurityKey privateKey)
    {
    ...
    {
        var securityKey = new JsonWebKey(_privateKey.JwkValue);
        var signingCredentials = new SigningCredentials(securityKey, _privateKey.Algorithm);
